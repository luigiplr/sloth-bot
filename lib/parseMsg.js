        ...
        return new Promise(function(resolve) {
            ...
            switch (parsedimput[0].toLowerCase()) {
                ...
                case 'kick':
                    ...
                    break;
                case 'eval':
                    codepad.eval(user, queary.split(' ')[0], queary.split('```')[1])
                        .then(resolve);
                    break;
                case 'quotes':
                ...
                case 'h':
                case 'help':
                    this.showHelp(user).then(function(help) {
                        resolve({msg: help});
                    });
                    break;
                case 'ru':
                ...
                case 'lookofdisapproval':
                    ...
                    break;
                default:
                    resolve({msg: 'ಠ_ಠ ' + user + ' try again with a valid command. Type `' + prefix + 'help` for list of commands.'});
            }
        }.bind(this));
    },
        ...
        return new Promise(function(resolve) {
            switch (input) {
                case "ain't that right sloth?":
                    ...
                    resolve(pic + this.generatechars());
                    break;
                default:
                    resolve(false);
            }
