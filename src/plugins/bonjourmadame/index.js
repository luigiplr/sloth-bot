  ...
  return new Promise((resolve, reject) => {
    ...
    if (input)
      ...
      if (diff === 0)
        ...
        return resolve({ type: 'dm', message: 'Date must be in the past. Usage: bonjourmadame [void, \'today\', <MM.DD.YYYY>]' })
    } else
      return resolve({ type: 'dm', message: 'Usage: hellolady [void, \'today\', <MM.DD.YYYY>]' })
    else
